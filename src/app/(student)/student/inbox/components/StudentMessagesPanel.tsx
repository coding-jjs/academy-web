...
export default function StudentMessagesPanel({
    ...
    const activeMessage =
        filteredMessages.find(
            (message) => message.recipientId === activeMessageId,
        ) ??
        filteredMessages[0] ??
        null;
                    ...
                    {activeMessage && (
                        <article className={styles.detail}>
                            ...
                            <div className={styles.detailActions}>
                                {!activeMessage.readAt && (
                                    <form action={formAction}>
                                        <input
                                            type="hidden"
                                            name="recipientId"
                                            value={activeMessage.recipientId}
                                        />
                                        <button
                                            type="submit"
                                ...
                                {activeMessage.deepLink && (
                                    <Link
                                        href={activeMessage.deepLink}

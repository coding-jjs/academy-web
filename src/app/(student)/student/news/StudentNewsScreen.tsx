...
import styles from "./StudentNewsScreen.module.css";
...
> = {
    ...
    STUDENT_YOUTH: { label: "체험·진로", tone: "success" },
    GENERAL: { label: "일반", tone: "neutral" },
};

const filters: Array<{ id: "ALL" | "STUDENT_YOUTH" | "GENERAL"; label: string }> =
    [
        { id: "ALL", label: "전체" },
...
export default function StudentNewsScreen({
    ...
    const [filter, setFilter] = useState<"ALL" | "STUDENT_YOUTH" | "GENERAL">(
        "ALL",
    );
